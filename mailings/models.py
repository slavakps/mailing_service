...
class Mailing(models.Model):
    ...
    status = models.CharField(choices=STATUSES, verbose_name="Статус", default="created")
...
class Attempt(models.Model):
    ...
    status = models.CharField(choices=STATUSES, verbose_name="Статус", default="ok")
    server_response = models.CharField(max_length=255, verbose_name="ответ сервера", null=True, blank=True)
